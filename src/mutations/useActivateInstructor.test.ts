...
import { useActivateInstructor } from "./useActivateInstructor";

describe("useActivateInstructor", () => {
  it("activates an instructor and invalidates instructors", async () => {
    ...
    expect(authFetchSpy).toHaveBeenCalledWith("instructors/4/activate", { method: "PATCH" });
