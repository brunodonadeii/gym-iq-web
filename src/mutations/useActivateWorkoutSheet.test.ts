...
import { useActivateWorkoutSheet } from "./useActivateWorkoutSheet";

describe("useActivateWorkoutSheet", () => {
  it("activates a workout sheet and invalidates workout sheets", async () => {
    ...
    expect(authFetchSpy).toHaveBeenCalledWith("workout-sheets/8/activate", { method: "PATCH" });
